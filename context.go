...
func (c *Context) HttpAttachment(file http.File, name string) error {
	return c.contentDisposition(file, name, ContentDispositionTypeAttachment)
}

func (c *Context) HttpInline(file http.File, name string) error {
	return c.contentDisposition(file, name, ContentDispositionTypeInline)
}
...
func (c *Context) contentDisposition(file http.File, name string, dispositionType ContentDispositionType) error {
	c.Response().Header().Set(HeaderContentDisposition, ContentDisposition(name, dispositionType))
